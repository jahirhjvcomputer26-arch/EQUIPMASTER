            ...
            <div className="p-6 md:p-8 space-y-5">
              {(() => {
                ...
                return isLocal ? (
                  ...
                  <div className="w-full py-3 rounded-xl border-2 border-dashed border-slate-200 bg-slate-50 text-slate-400 font-bold text-sm flex items-center justify-center gap-2 cursor-not-allowed" title="Solo disponible en la red local del taller (LAN). En producción, ingresa los datos manualmente.">
                    <i className="fa-solid fa-microchip" /> Detectar Hardware (solo en red local)
                  </div>
                );
              })()}
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
